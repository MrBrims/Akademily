<div class="tab tab-price">
    <div class="tab__nav-inner tab-price__nav-inner">
        <?php foreach ((carbon_get_theme_option('price_tab_nav')) as $key) : ?>
                ...
                <div class="tab-price__items">
                    <div class="tab-price__item">
                        ...
                        <div class="tab-price__num">
                            <?php echo $key['price_tab_num_pref']; ?>
                            <span class="tab-price__num-accent">
                                <?php echo $key['price_tab_num']; ?>
                                <?php echo $key['price_tab_num_currency']; ?>
                            </span>
                    ...
                    <div class="tab-price__item">
                        <?php echo apply_filters('the_content',  $key['price_tab_list']); ?>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
